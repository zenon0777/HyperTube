    ...
    <main className="min-h-screen bg-black flex flex-col overflow-hidden">
      <div className="relative min-h-screen max-w-[1500px] mx-auto bg-gray-900 text-white w-full flex flex-col">
        <motion.header
          ...
          className="absolute top-0 left-0 w-full lg:px-4 px-0 lg:py-4 py-2 flex justify-between items-center bg-transparent z-50"
        >
          <NavBar />
        </motion.header>
        {/* Header with Fade-In Animation */}

        {/* Swiper for Full-Page Movies with Enhanced Animations */}
